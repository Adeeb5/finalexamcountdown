        ...
        try:
            ...
            if path == '/api/matric' or path.endswith('/matric'):
                ...
                system_instruction = (
                    ...
                    "   - ITT300 is **Introduction to Data Communication & Networking** (NOT Systems Analysis and Design)\n"
                    ...
                    "2. If the student asks about a specific course code, its final exam, or its scheme of work, you MUST proactively reference the correct course name and search for the exact syllabus structure.\n"
