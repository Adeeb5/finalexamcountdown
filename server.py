        ...
        try:
            ...
            if path == '/api/matric' or path.endswith('/matric'):
                ...
                system_instruction = (
                    ...
                    "RESEARCH & COURSE MAPPING PROTOCOL:\n"
                    "1. When a student mentions a course code, you MUST map it correctly. For reference:\n"
                    "   - **ITT300** is *Introduction to Data Communication & Networking* (Final Exam: 50% ● Chapter 5 ● Chapter 6 ● Chapter 7 ● Chapter 8 ● Chapter 9 ● Chapter 10)\n"
                    "   - **CSC248** is *Fundamentals of Data Structures* (Final Exam: 40% ● Topic 4: Queue ● Topic 5: Stack ● Topic 6: Trees)\n"
                    "   - **CSC128** is *Introduction to Computer Programming* / *Fundamentals of Computer Problem Solving* (Final Exam: 40% ● Chapter 3: Control Structure Selection ● Chapter 4: Control Structure Repetition/Loops ● Chapter 5: Functions ● Chapter 6: Arrays)\n"
                    "   - **MAT112** is *Business Mathematics* (Final Exam: 50% ● Simple Interest ● Bank Discount & Promissory Notes ● Compound Interest ● Annuity ● Trade & Cash Discounts ● Markup & Markdown ● Instalment Purchase ● Depreciation)\n"
                    "   - **ENT300** is *Fundamentals of Entrepreneurship* (No traditional final exam. Coursework: 100% ● Business Plan project ● Business Model Canvas (BMC) ● Case Study ● Pitching)\n"
                    "   - **CTU551** is *Tamadun Islam dan Tamadun Asia (TITAS)* (Final Assessment: 50% ● Bab 1 - Bab 9 online MCQ / structured test)\n"
                    "2. If the student asks about a specific course code, its final exam, or its scheme of work, you MUST proactively reference the correct course name and syllabus chapters. Avoid proposing generic chapters or weightages. Match the exact weights and topics defined in the list above.\n"
                    "3. FALLBACK & WEB SEARCH FOR OTHER COURSE CODES:\n"
                    "   - If the student inquires about a course code NOT listed above, you MUST call the `google_search` tool immediately with a query like '[course code] syllabus scheme of work' or '[course code] topics' to fetch the correct details before answering.\n"
                    "   - After receiving the search results, present the findings accurately. If the search returns no results, politely ask the student to share their specific final exam topics, chapters, or Scheme of Work (SOW) details.\n"
                    "4. You MUST be highly particular about identifying the specific chapters/topics included in the final exam. When outlining exam coverage, detail the assessment weightage and chapter breakdown clearly. For example, for ITT300, structure it like this:\n"
                    "   * **Final Exam – 50%** ● Chapter 5 ● Chapter 6 ● Chapter 7 ● Chapter 8 ● Chapter 9 ● Chapter 10\n"
                    "   For CSC248, structure it like this:\n"
                    "   * **Final Exam – 40%** ● Topic 4 ● Topic 5 ● Topic 6\n"
                    "   For MAT112, structure it like this:\n"
                    "   * **Final Exam – 50%** ● Simple & Compound Interest ● Bank Discount ● Annuity ● Markup & Markdown ● Instalment Purchase ● Depreciation\n"
                    "5. If you want to verify the latest curriculum, trigger `google_search` or suggest checking the Scheme of Work (SOW) topics to make the revision plan highly precise.\n\n"
                    ...
                    "- Examples of what to use in Malay:\n"
