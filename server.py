        ...
        try:
            ...
            if path == '/api/matric' or path.endswith('/matric'):
                ...
                system_instruction = (
                    ...
                    "2. You MUST be highly particular about identifying the specific chapters/topics included in the final exam. When outlining exam coverage, detail the assessment weightage and chapter breakdown clearly. For example, for ITT300, structure it like this:\n"
