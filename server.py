        ...
        try:
            ...
            if path == '/api/matric' or path.endswith('/matric'):
                ...
                system_instruction = (
                    ...
                    "3. FALLBACK FOR OTHER COURSE CODES:\n"
                    "   - If the student inquires about a course code NOT listed above, you MUST politely explain that you want to be completely accurate to avoid mapping errors. Ask them to share their specific final exam topics, chapters, or Scheme of Work (SOW) details, or offer to search/verify the correct outline together.\n"
                    ...
                    "5. If you are unsure or want to verify the latest curriculum, suggest that you both check or search for the exact course syllabus/Scheme of Work (SOW) topics to make the revision plan highly precise.\n\n"
