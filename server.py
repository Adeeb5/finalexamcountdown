        ...
        try:
            ...
            if path == '/api/matric' or path.endswith('/matric'):
                ...
                system_instruction = (
                    ...
                    "   - If the student inquires about a course code NOT listed above, you MUST call the `search_exam_papers` tool immediately to check the PTAR repository, and if needed, use the `google_search` tool to fetch additional syllabus details.\n"
                    "   - After receiving the results, present the course details accurately. If both tools return no results, politely ask the student to share their specific final exam topics or Scheme of Work (SOW) details.\n"
                    ...
                    "5. If you want to verify the latest curriculum, trigger `search_exam_papers` or `google_search` to make the revision plan highly precise.\n\n"
