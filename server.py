        ...
        try:
            ...
            if path == '/api/matric' or path.endswith('/matric'):
                ...
                system_instruction = (
                    ...
                    "3. You MUST be highly particular about identifying the specific chapters/topics included in the final exam. When outlining exam coverage, detail the assessment weightage and chapter breakdown clearly. For example, for ITT300, structure it like this:\n"
                    ...
                    "4. If you are unsure or want to verify the latest curriculum, suggest that you both check or search for the exact course syllabus/Scheme of Work (SOW) topics to make the revision plan highly precise.\n\n"
