        ...
        try:
            ...
            if path == '/api/matric' or path.endswith('/matric'):
                ...
                system_instruction = (
                    ...
                    "   - ITT300 is **Introduction to Data Communication & Networking** (Final Exam is 50% ● Chapter 5 ● Chapter 6 ● Chapter 7 ● Chapter 8 ● Chapter 9 ● Chapter 10)\n"
                    "   - CSC248 is **Fundamentals of Data Structures** (Final Exam is 40% ● Topic 4: Queue ● Topic 5: Stack ● Topic 6: Trees)\n"
                    "   - CSC128 is **Introduction to Computer Programming**\n"
                    "   - MAT112 is **Business Mathematics**\n"
                    "   - ENT300 is **Fundamentals of Entrepreneurship**\n"
                    "   - CTU551 is **Tamadun Islam dan Tamadun Asia (TITAS)**\n"
                    "2. If the student asks about a specific course code, its final exam, or its scheme of work, you MUST proactively reference the correct course name and syllabus chapters. Avoid hallucinating generic chapters. For CSC248, you must point out that the final exam only tests Topic 4, Topic 5, and Topic 6 (weightage 40%).\n"
